    ...
    for i = 0, num_mrkrgn - 1 do
      ...
      if name == filename then
        if #line_split == 2 then -- es solo QA Audio...
          reaper.AddProjectMarker2(0, 0, pos, 0, line_split[2], -1, 0x1E16941)
        elseif #line_split == 3 then -- o tiene CL?
          reaper.AddProjectMarker2(0, 0, pos, 0, line_split[2] .. " // CL: " .. line_split[3], -1, 0x1912ebf)
        end
      end
    end
  end
